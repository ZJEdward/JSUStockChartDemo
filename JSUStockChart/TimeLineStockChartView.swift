...
open class TimeLineStockChartView:KLineStockChartViewBase{
    ...
    func drawLabelRatio(_ context:CGContext){
        ...
        self.drawLabel(context, attributesText: minRatioAttStr, rect: CGRect(x: labelX, y: ((self.uperChartHeightScale * self.contentHeight) + self.contentTop - sizeMinRatioAttStr.height ), width: sizeMinRatioAttStr.width, height: sizeMinRatioAttStr.height))
    }
    ...
    override func drawGridBackground(_ context:CGContext,rect:CGRect){
        ...
        self.drawline(context, startPoint: CGPoint(x: self.contentWidth/2.0 + self.contentLeft, y: self.contentTop), stopPoint: CGPoint(x: self.contentWidth/2.0 + self.contentLeft,y: (self.uperChartHeightScale * self.contentHeight)+self.contentTop), color: self.borderColor , lineWidth: self.borderWidth/2.0)
    }
        ...
        if !self.highlightLineCurrentEnabled{
            ...
            if let d = self.dataSet?.days, showFiveDayLabel{
                ...
                for (index,day) in d.enumerated(){
                    ...
                    self.drawLabel(context, attributesText: startTimeAttStr, rect: CGRect(x: self.contentLeft + (width - sizeStartTimeAttStr.width) / 2 + width * CGFloat(index), y: (self.uperChartHeightScale * self.contentHeight+self.contentTop), width: sizeStartTimeAttStr.width, height: sizeStartTimeAttStr.height))
                }
                ...
                let sizeStartTimeAttStr = startTimeAttStr.size()
                self.drawLabel(context, attributesText: startTimeAttStr, rect: CGRect(x: self.contentLeft, y: (self.uperChartHeightScale * self.contentHeight+self.contentTop), width: sizeStartTimeAttStr.width, height: sizeStartTimeAttStr.height))
                ...
                self.drawLabel(context, attributesText: midTimeAttStr, rect: CGRect(x: self.contentWidth/2.0 + self.contentLeft - sizeMidTimeAttStr.width/2.0, y: (self.uperChartHeightScale * self.contentHeight+self.contentTop), width: sizeMidTimeAttStr.width, height: sizeMidTimeAttStr.height))
                ...
                self.drawLabel(context, attributesText: stopTimeAttStr, rect: CGRect(x: self.contentRight - sizeStopTimeAttStr.width, y: (self.uperChartHeightScale * self.contentHeight+self.contentTop), width: sizeStopTimeAttStr.width, height: sizeStopTimeAttStr.height))
            }
...
//                        CGPathMoveToPoint(fillPath, nil, self.contentLeft, (self.uperChartHeightScale * self.contentHeight) + self.contentInnerTop / 2 );
                        fillPath.move(to: CGPoint(x: self.contentLeft, y: (self.uperChartHeightScale * self.contentHeight) + self.contentInnerTop / 2 ))
//                        CGPathAddLineToPoint(fillPath, nil, self.contentLeft, lastYPrice);
                        fillPath.addLine(to: CGPoint(x: self.contentLeft, y: lastYPrice))
...
//                        CGPathAddLineToPoint(fillPath, nil, startX, (self.uperChartHeightScale * self.contentHeight) + self.contentInnerTop / 2);
                        fillPath.addLine(to: CGPoint(x: startX, y: (self.uperChartHeightScale * self.contentHeight) + self.contentInnerTop / 2))
