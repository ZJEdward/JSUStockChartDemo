...
open class KLineStockChartViewBase: StockChartBase {
    ...
    var gridBackgroundColor:UIColor = UIColor.white
    ...
    var defaultAttributedDic:[String:AnyObject]{
        get{
            return [NSFontAttributeName:UIFont.systemFont(ofSize: 10),NSBackgroundColorAttributeName:gridBackgroundColor]
        }
    }
    
    var leftYAxisAttributedDic:[String:AnyObject] = [NSFontAttributeName:UIFont.systemFont(ofSize: 9),NSBackgroundColorAttributeName:UIColor.clear,NSForegroundColorAttributeName:UIColor(netHex: 0x8695a6, alpha: 1)]
    var xAxisAttributedDic = [NSFontAttributeName:UIFont.systemFont(ofSize: 10),NSBackgroundColorAttributeName:UIColor.clear,NSForegroundColorAttributeName:UIColor(netHex: 0x8695a6, alpha: 1)]
    var highlightAttributedDic = [NSFontAttributeName:UIFont.systemFont(ofSize: 10),NSBackgroundColorAttributeName:UIColor(netHex: 0x8695a6, alpha: 1),NSForegroundColorAttributeName:UIColor.white]
    ...
    func drawGridBackground(_ context:CGContext,rect:CGRect){
        ...
        context.stroke(CGRect(x: self.contentLeft, y: self.contentTop, width: self.contentWidth, height: (self.uperChartHeightScale * self.contentHeight)));
        ...
        self.drawline(context, startPoint: CGPoint(x: self.contentLeft,y: self.contentInnerTop + (self.uperChartHeightScale * self.contentHeight)-self.contentInnerTop), stopPoint: CGPoint(x: self.contentLeft+self.contentWidth,y: self.contentInnerTop + (self.uperChartHeightScale * self.contentHeight)-self.contentInnerTop), color: self.borderColor, lineWidth: self.borderWidth/2.0)
        
        //画交易量边框
        context.stroke(CGRect(x: self.contentLeft, y: (self.uperChartHeightScale * self.contentHeight)+self.xAxisHeitht, width: self.contentWidth, height: (self.contentBottom - (self.uperChartHeightScale * self.contentHeight)-self.xAxisHeitht)));
        
        //画中间的线
        self.drawline(context, startPoint: CGPoint(x: self.contentLeft,y: (self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop), stopPoint: CGPoint(x: self.contentRight, y: (self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop), color: self.borderColor, lineWidth: self.borderWidth/2.0)
        
        self.drawline(context, startPoint: CGPoint(x: self.contentLeft,y: (self.uperChartHeightScale * self.contentInnerHeight)/4.0 + self.contentInnerTop), stopPoint: CGPoint(x: self.contentRight, y: (self.uperChartHeightScale * self.contentInnerHeight)/4.0 + self.contentInnerTop), color: self.borderColor, lineWidth: self.borderWidth/2.0)
        
        self.drawline(context, startPoint: CGPoint(x: self.contentLeft,y: (self.uperChartHeightScale * self.contentInnerHeight)*0.75 + self.contentInnerTop), stopPoint: CGPoint(x: self.contentRight, y: (self.uperChartHeightScale * self.contentInnerHeight)*0.75 + self.contentInnerTop), color: self.borderColor, lineWidth: self.borderWidth/2.0)
    }
    ...
    func drawLabelPrice(_ context:CGContext){
        ...
        if !self.highlightLineCurrentEnabled{
            ...
            if drawMidLabelPrice{
                ...
                self.drawLabel(context, attributesText: midPriceAttStr, rect: CGRect(x: labelX, y: ((self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop)-sizeMidPriceAttStr.height/2.0, width: sizeMidPriceAttStr.width, height: sizeMidPriceAttStr.height))
            }
            ...
            self.drawLabel(context, attributesText: minPriceAttStr, rect: CGRect(x: labelX, y: ((self.uperChartHeightScale * self.contentHeight) + self.contentTop - sizeMinPriceAttStr.height ), width: sizeMinPriceAttStr.width, height: sizeMinPriceAttStr.height))
        }
        ...
        if drawVolumeLabel{
            ...
            self.drawLabel(context, attributesText: maxVolumeAttStr, rect: CGRect(x: self.contentLeft - maxVolumeAttStrSize.width, y: (self.uperChartHeightScale * self.contentHeight)+self.xAxisHeitht, width: maxVolumeAttStrSize.width, height: maxVolumeAttStrSize.height))
        }
    ...
    func drawHighlighted(_ context:CGContext,point:CGPoint,idex:Int,value:AnyObject,color:UIColor,lineWidth:CGFloat){
        var leftMarkerStr = ""
        var bottomMarkerStr = ""
        var rightMarkerStr = ""
...
//        }
        ...
        self.drawLabel(context, attributesText: bottomMarkerStrAtt, rect: CGRect(x: point.x - bottomMarkerStrAttSize.width/2.0,  y: ((self.uperChartHeightScale * self.contentHeight) + self.contentTop), width: bottomMarkerStrAttSize.width, height: bottomMarkerStrAttSize.height))
    ...
    func drawline(_ context:CGContext,startPoint:CGPoint,stopPoint:CGPoint,color:UIColor,lineWidth:CGFloat){
