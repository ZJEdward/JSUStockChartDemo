...
class JSUKLineViewController: UIViewController,KLineChartViewDelegate {
    ...
    func setupKLineView(_ data:[JSUKLineModel]){
    ...
    func chartKlineScrollLeft(_ chartView: StockChartBase) {
    ...
    override func viewDidLoad() {
        ...
        self.kLineView.isUserInteractionEnabled = true
        self.kLineView.setupChartOffsetWithLeft(16,top:10,right:16,bottom:10)
        self.kLineView.gridBackgroundColor = UIColor.white
